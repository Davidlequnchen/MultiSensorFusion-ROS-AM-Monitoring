...
(cl:in-package aimen_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimen_driver-srv:<SrvRobotCommand-request> is deprecated: use aimen_driver-srv:SrvRobotCommand-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <SrvRobotCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimen_driver-srv:command-val is deprecated.  Use aimen_driver-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-request>)))
  ...
  "aimen_driver/SrvRobotCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-request)))
  "Returns string type for a service object of type 'SrvRobotCommand-request"
  "aimen_driver/SrvRobotCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimen_driver-srv:<SrvRobotCommand-response> is deprecated: use aimen_driver-srv:SrvRobotCommand-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <SrvRobotCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimen_driver-srv:response-val is deprecated.  Use aimen_driver-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-response>)))
  ...
  "aimen_driver/SrvRobotCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-response)))
  "Returns string type for a service object of type 'SrvRobotCommand-response"
  "aimen_driver/SrvRobotCommandResponse")
