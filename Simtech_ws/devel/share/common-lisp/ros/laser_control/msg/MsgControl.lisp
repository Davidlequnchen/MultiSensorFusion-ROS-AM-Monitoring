...
(cl:defmethod cl:initialize-instance :after ((m <MsgControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_control-msg:<MsgControl> is deprecated: use laser_control-msg:MsgControl instead.")))

(cl:ensure-generic-function 'change-val :lambda-list '(m))
(cl:defmethod change-val ((m <MsgControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:change-val is deprecated.  Use laser_control-msg:change instead.")
  (change m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <MsgControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:value-val is deprecated.  Use laser_control-msg:value instead.")
  (value m))
