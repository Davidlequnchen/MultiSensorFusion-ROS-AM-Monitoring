...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/ROS_utils/imag_pipline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/ROS_utils/imag_pipline/camera_calibration/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/ROS_utils/imag_pipline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
