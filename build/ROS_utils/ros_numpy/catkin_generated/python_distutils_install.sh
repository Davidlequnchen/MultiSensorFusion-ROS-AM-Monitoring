...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/ROS_utils/ros_numpy"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/ROS_utils/ros_numpy/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/ROS_utils/ros_numpy" \
    install \
    --root="${DESTDIR-/}" \
