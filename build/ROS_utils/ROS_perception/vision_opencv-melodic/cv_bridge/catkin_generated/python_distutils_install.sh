...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/ROS_utils/ROS_perception/vision_opencv-melodic/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/ROS_utils/ROS_perception/vision_opencv-melodic/cv_bridge/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/ROS_utils/ROS_perception/vision_opencv-melodic/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
