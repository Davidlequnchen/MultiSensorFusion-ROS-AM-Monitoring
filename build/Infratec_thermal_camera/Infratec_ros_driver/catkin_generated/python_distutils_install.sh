...
echo_and_run cd "/home/artc/GitHub/SIMTech_ws/src/Infratec_thermal_camera/Infratec_ros_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/artc/GitHub/SIMTech_ws/src/Infratec_thermal_camera/Infratec_ros_driver/setup.py" \
     \
    build --build-base "/home/artc/GitHub/SIMTech_ws/build/Infratec_thermal_camera/Infratec_ros_driver" \
    install \
    --root="${DESTDIR-/}" \
