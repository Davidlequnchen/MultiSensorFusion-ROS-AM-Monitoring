...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/Infratec_thermal_camera/Infratec_ros_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/Infratec_thermal_camera/Infratec_ros_driver/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/Infratec_thermal_camera/Infratec_ros_driver" \
    install \
    --root="${DESTDIR-/}" \
