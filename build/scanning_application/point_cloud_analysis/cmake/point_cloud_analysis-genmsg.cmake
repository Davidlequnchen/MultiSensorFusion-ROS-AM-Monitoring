...
set(MSG_I_FLAGS "-Ipoint_cloud_analysis:/home/chenlequn/SIMTech_ws/src/scanning_application/point_cloud_analysis/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chenlequn/SIMTech_ws/src/scanning_application/point_cloud_analysis/msg/MsgHeightMonitoring.msg" NAME_WE)
add_custom_target(_point_cloud_analysis_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "point_cloud_analysis" "/home/chenlequn/SIMTech_ws/src/scanning_application/point_cloud_analysis/msg/MsgHeightMonitoring.msg" ""
)

get_filename_component(_filename "/home/chenlequn/SIMTech_ws/src/scanning_application/point_cloud_analysis/msg/MsgPointCloudScan.msg" NAME_WE)
add_custom_target(_point_cloud_analysis_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "point_cloud_analysis" "/home/chenlequn/SIMTech_ws/src/scanning_application/point_cloud_analysis/msg/MsgPointCloudScan.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/point_cloud_analysis)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/point_cloud_analysis\")")
  # install generated code
  install(
