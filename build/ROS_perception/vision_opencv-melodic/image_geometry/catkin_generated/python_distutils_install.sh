...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/ROS_perception/vision_opencv-melodic/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/home/chenlequn/SIMTech_ws/src/ROS_perception/vision_opencv-melodic/image_geometry/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/ROS_perception/vision_opencv-melodic/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
