...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/ROS_perception/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/home/chenlequn/SIMTech_ws/src/ROS_perception/image_pipeline/camera_calibration/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/ROS_perception/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
