...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/proper-master/proper_jason"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/proper-master/proper_jason/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/proper-master/proper_jason" \
    install \
    --root="${DESTDIR-/}" \
