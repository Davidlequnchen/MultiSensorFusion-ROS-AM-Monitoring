...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/motion_planning"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/motion_planning/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/motion_planning" \
    install \
    --root="${DESTDIR-/}" \
