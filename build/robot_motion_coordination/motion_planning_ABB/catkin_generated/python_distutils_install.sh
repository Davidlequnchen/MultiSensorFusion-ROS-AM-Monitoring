...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_ABB"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_ABB/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/robot_motion_coordination/motion_planning_ABB" \
    install \
    --root="${DESTDIR-/}" \
