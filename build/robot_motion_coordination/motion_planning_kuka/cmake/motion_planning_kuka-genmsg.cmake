...
get_filename_component(_filename "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka/srv/SrvRobotCommand.srv" NAME_WE)
add_custom_target(_motion_planning_kuka_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motion_planning_kuka" "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka/srv/SrvRobotCommand.srv" ""
)
...
_generate_srv_cpp(motion_planning_kuka
  "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka/srv/SrvRobotCommand.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_planning_kuka)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_planning_kuka\")")
  # install generated code
  install(
