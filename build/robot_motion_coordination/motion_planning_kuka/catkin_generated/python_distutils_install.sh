...
echo_and_run cd "/home/artc/GitHub/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/artc/GitHub/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka/setup.py" \
     \
    build --build-base "/home/artc/GitHub/SIMTech_ws/build/robot_motion_coordination/motion_planning_kuka" \
    install \
    --root="${DESTDIR-/}" \
