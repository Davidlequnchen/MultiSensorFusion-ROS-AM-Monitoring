...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chenlequn/SIMTech_ws/src/robot_motion_coordination/motion_planning_kuka/setup.py" \
     \
    build --build-base "/home/chenlequn/SIMTech_ws/build/robot_motion_coordination/motion_planning_kuka" \
    install \
    --root="${DESTDIR-/}" \
