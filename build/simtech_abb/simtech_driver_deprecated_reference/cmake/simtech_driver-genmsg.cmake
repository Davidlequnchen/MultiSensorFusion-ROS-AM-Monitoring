...
get_filename_component(_filename "/home/chenlequn/SIMTech_ws/src/simtech_abb/simtech_driver_deprecated_reference/srv/SrvRobotCommand.srv" NAME_WE)
add_custom_target(_simtech_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "simtech_driver" "/home/chenlequn/SIMTech_ws/src/simtech_abb/simtech_driver_deprecated_reference/srv/SrvRobotCommand.srv" ""
)
...
_generate_srv_cpp(simtech_driver
  "/home/chenlequn/SIMTech_ws/src/simtech_abb/simtech_driver_deprecated_reference/srv/SrvRobotCommand.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/simtech_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/simtech_driver\")")
  # install generated code
  install(
