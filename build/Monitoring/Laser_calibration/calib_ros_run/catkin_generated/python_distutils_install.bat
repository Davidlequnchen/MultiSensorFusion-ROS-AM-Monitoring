...
cd "C:/Users/MI/Desktop/Github/src/Monitoring/Laser_calibration/calib_ros_run"
...
"C:/Opt/python27amd64/python.exe" ^
    ...
    build --build-base "C:/Users/MI/Desktop/Github/build/Monitoring/Laser_calibration/calib_ros_run" ^
    install %DESTDIR_ARG%  ^
