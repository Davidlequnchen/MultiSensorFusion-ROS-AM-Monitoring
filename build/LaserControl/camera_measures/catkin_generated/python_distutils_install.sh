...
echo_and_run cd "/home/chenlequn/SIMTech_ws/src/LaserControl/camera_measures"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/chenlequn/SIMTech_ws/build/LaserControl/camera_measures" \
    install \
    --root="${DESTDIR-/}" \
