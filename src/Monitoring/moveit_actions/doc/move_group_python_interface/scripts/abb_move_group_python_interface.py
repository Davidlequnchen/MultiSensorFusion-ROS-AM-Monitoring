...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def __init__(self):
    ...
    rospy.init_node('abb_move_group_python_interface',
                    anonymous=True)
  ...
  def go_to_joint_state(self):
    ...
    # set_max_velocity_scaling_factor enables you to set the motion velocity in a scalling factor of the velocity limit between 0-1
  ...
  def plan_cartesian_path(self, scale=1):
    ...
    wpose.position.z -= scale * 0.25  # First move down (z)
    ...
    wpose.position.y += scale * 0.25  # Second move
    wpose.orientation.w = 1.0
    wpose.orientation.x = 0.15
    wpose.orientation.y = 0.0
    wpose.orientation.z = 0.0
    waypoints.append(copy.deepcopy(wpose))

    wpose.position.x -= scale * 0.25  # Third move sideways (x)
    wpose.position.z += scale * 0.1
    wpose.orientation.w = 1.0
    wpose.orientation.x = 0.0
    wpose.orientation.y = 0.1
