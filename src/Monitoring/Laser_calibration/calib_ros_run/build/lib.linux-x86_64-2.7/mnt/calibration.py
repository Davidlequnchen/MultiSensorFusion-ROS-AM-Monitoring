...
class CameraCalibration():
    ...
    def get_chessboard_pose(self, grid):
        ...
        if grid is not None:
            ...
            # 2D-3D mapping, coordinate conversion
        return None
    ...
    def find_transformation(self, object_points, image_points):
        """Finds the rotation and translation transformation. 2D-3D mapping, coordinate conversion, based on camera parameters"""
...
class LaserCalibration(CameraCalibration):
    ...
    def find_calibration_3d(self, images):
        ...
        - get chessboard 3D pose coordinate, 2D-3D mapping, based on the camera parameters we got 
        - In each image, by using homographic projection method, get the laser line 3D coordinate corresponding to the chessboard plane.
        - find_best_line2d
...
if __name__ == '__main__':
    ...
    # implement the laser calibration procedure and find the pose of the laser plane
    ...
    for k, img in enumerate(images):
        ...
        if len(profiles[k]) > 0:
            ...
            cv2.imwrite('../../data/calib4/board%i.png' %k, imgc)
