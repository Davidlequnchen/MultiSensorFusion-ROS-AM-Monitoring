...
PCLFile = "23_seg.pcd"   # the point cloud file generated by PCL
planeFile = "23_coefficient.txt"   # this file contains only the a, b, c, d coefficient of the plane (ax + by + cz + d = 0)
distanceFile = "23_distance.txt"   # contains vertical distance FROM the plane TO all points
...
pio.write_html(fig, file="23.html", auto_open=True)
