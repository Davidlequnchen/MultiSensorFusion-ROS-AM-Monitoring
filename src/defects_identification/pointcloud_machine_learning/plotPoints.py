...
PCLFile = "V_repaired_seg2.pcd"   # the point cloud file generated by PCL
planeFile = "coefficient_v_repaired2.txt"   # this file contains only the a, b, c, d coefficient of the plane (ax + by + cz + d = 0)
distanceFile = "distance_v_repaired2.txt"   # contains vertical distance FROM the plane TO all points
# normalFile = "normalEstimation_23.txt"   # normal vector and curvature (nx, ny, nz, c) of all points
...
pio.write_html(fig, file="v_repaired_2.html", auto_open=True)
