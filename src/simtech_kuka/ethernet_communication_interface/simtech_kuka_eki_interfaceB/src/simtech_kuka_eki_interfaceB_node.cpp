...
#include <simtech_kuka_eki_interfaceB/SrvRobotCommand.h>
...
class NdKukaRobotInterface {
    ...
    public:
        ...
        simtech_kuka_eki_interfaceB::KukaEkiHardwareInterface hardware_interface;
        ...
        bool cb_robot_command(simtech_kuka_eki_interfaceB::SrvRobotCommand::Request  &req,
                              simtech_kuka_eki_interfaceB::SrvRobotCommand::Response &res)
        {
            try{
...
{
  ros::init(argc, argv, "simtech_kuka_eki_interfaceB");
  ...
  spinner.stop();
  ROS_INFO_STREAM_NAMED("simtech_kuka_eki_interfaceB", "Shutting down.");
