                       ...
                       pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud_out)
{
  ...
  //Set the voxel grid leaf size(x, y, z) 
                   ...
                   pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud_out)
{
  ...
  // RadiusOutlierRemoval class: filters points in a cloud based on the number of neighbors they have
  pcl::RadiusOutlierRemoval<pcl::PointXYZ> outrem;
  outrem.setInputCloud(cloud_in);//[in]	cloud	the const boost shared pointer to a PointCloud message 
  //setRadiusSearch: Set the radius of the sphere that will determine which points are neighbors. 
  //The number of points within this distance from the query point will need to be equal or greater than 
  //setMinNeighborsInRadius() in order to be classified as an inlier point (i.e. will not be filtered). 
