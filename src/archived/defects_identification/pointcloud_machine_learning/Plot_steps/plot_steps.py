...
# PCLFile = "10.pcd" # the original scanning Point cloud 
# PCL_sfiltered = "10_sfiltered.pcd" # Point Cloud after statistical filtering (noise cancelling)
# PCL_vfiltered = "10_vfiltered.pcd" # point cloud after apply the voxel grid filter (downsampling)
PCLFile_seg = "10_seg.pcd"   # the point cloud after segmentation
planeFile = "coefficient_10.txt"   # this file contains only the a, b, c, d coefficient of the plane (ax + by + cz + d = 0)
distanceFile = "distance_10.txt"   # contains vertical distance FROM the plane TO all points
# normalFile = "normalEstimation_10.txt"   # normal vector and curvature (nx, ny, nz, c) of all points
...
# pio.write_html(fig, file="10.html", auto_open=True)
...
#                   )
# # Use the offline mode of plotly:
# pio.write_html(fig, file="10_noise_canclled.html", auto_open=True)
...
#                   )
# # Use the offline mode of plotly:
# pio.write_html(fig, file="10_downsampled.html", auto_open=True)
...
# Use the offline mode of plotly:
pio.write_html(fig, file="10_Seg.html", auto_open=True)
