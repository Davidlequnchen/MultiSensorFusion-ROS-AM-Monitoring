...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/artc/GitHub/SIMTech_ws/src/ROS_utils/ROS_perception/vision_opencv-noetic/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/artc/GitHub/SIMTech_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/artc/GitHub/SIMTech_ws/install)
...
if(NOT "/home/artc/GitHub/SIMTech_ws/src/ROS_utils/ROS_perception/vision_opencv-noetic/image_geometry/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/artc/GitHub/SIMTech_ws/src/ROS_utils/ROS_perception/vision_opencv-noetic/image_geometry/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/artc/GitHub/SIMTech_ws/src/ROS_utils/ROS_perception/vision_opencv-noetic/image_geometry/${idir}'.  ${_report}")
    endif()
