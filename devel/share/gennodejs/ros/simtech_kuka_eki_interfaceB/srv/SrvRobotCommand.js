...
// (in-package simtech_kuka_eki_interfaceB.srv)
...
class SrvRobotCommandRequest {
  ...
  static datatype() {
    ...
    return 'simtech_kuka_eki_interfaceB/SrvRobotCommandRequest';
  }
...
class SrvRobotCommandResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'simtech_kuka_eki_interfaceB/SrvRobotCommandResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'simtech_kuka_eki_interfaceB/SrvRobotCommand'; }
};
