...
class ContourArea {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.area, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ContourArea(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [area]
    data.area = _arrayDeserializer.float64(buffer, bufferOffset, null)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ContourArea(null);
