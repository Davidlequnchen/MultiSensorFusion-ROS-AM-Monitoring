...
// (in-package simtech_kuka_eki_interface_machining.srv)
...
class SrvRobotCommandRequest {
  ...
  static datatype() {
    ...
    return 'simtech_kuka_eki_interface_machining/SrvRobotCommandRequest';
  }
...
class SrvRobotCommandResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'simtech_kuka_eki_interface_machining/SrvRobotCommandResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'simtech_kuka_eki_interface_machining/SrvRobotCommand'; }
};
