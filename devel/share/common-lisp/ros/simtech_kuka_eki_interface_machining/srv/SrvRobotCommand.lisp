...
(cl:in-package simtech_kuka_eki_interface_machining-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simtech_kuka_eki_interface_machining-srv:<SrvRobotCommand-request> is deprecated: use simtech_kuka_eki_interface_machining-srv:SrvRobotCommand-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <SrvRobotCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simtech_kuka_eki_interface_machining-srv:command-val is deprecated.  Use simtech_kuka_eki_interface_machining-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-request>)))
  ...
  "simtech_kuka_eki_interface_machining/SrvRobotCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-request)))
  "Returns string type for a service object of type 'SrvRobotCommand-request"
  "simtech_kuka_eki_interface_machining/SrvRobotCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simtech_kuka_eki_interface_machining-srv:<SrvRobotCommand-response> is deprecated: use simtech_kuka_eki_interface_machining-srv:SrvRobotCommand-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <SrvRobotCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simtech_kuka_eki_interface_machining-srv:response-val is deprecated.  Use simtech_kuka_eki_interface_machining-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-response>)))
  ...
  "simtech_kuka_eki_interface_machining/SrvRobotCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-response)))
  "Returns string type for a service object of type 'SrvRobotCommand-response"
  "simtech_kuka_eki_interface_machining/SrvRobotCommandResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand)))
  ...
  "simtech_kuka_eki_interface_machining/SrvRobotCommand")