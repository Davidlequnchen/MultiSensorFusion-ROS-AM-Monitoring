...
(cl:defmethod cl:initialize-instance :after ((m <AudioDataStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AudioDataStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acoustic_monitoring_msgs-msg:<AudioDataStamped> is deprecated: use acoustic_monitoring_msgs-msg:AudioDataStamped instead.")))
...
(cl:defmethod data-val ((m <AudioDataStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acoustic_monitoring_msgs-msg:data-val is deprecated.  Use acoustic_monitoring_msgs-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AudioDataStamped>)))
  ...
  "acoustic_monitoring_msgs/AudioDataStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AudioDataStamped)))
  "Returns string type for a message object of type 'AudioDataStamped"
  "acoustic_monitoring_msgs/AudioDataStamped")
