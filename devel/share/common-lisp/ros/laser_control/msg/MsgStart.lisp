...
(cl:defmethod cl:initialize-instance :after ((m <MsgStart>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgStart)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_control-msg:<MsgStart> is deprecated: use laser_control-msg:MsgStart instead.")))

(cl:ensure-generic-function 'control-val :lambda-list '(m))
(cl:defmethod control-val ((m <MsgStart>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:control-val is deprecated.  Use laser_control-msg:control instead.")
  (control m))

(cl:ensure-generic-function 'setpoint-val :lambda-list '(m))
(cl:defmethod setpoint-val ((m <MsgStart>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:setpoint-val is deprecated.  Use laser_control-msg:setpoint instead.")
  (setpoint m))
