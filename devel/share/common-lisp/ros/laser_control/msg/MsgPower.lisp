...
(cl:defmethod cl:initialize-instance :after ((m <MsgPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_control-msg:<MsgPower> is deprecated: use laser_control-msg:MsgPower instead.")))
