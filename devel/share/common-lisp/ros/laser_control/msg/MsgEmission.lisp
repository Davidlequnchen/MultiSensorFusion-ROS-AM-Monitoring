...
(cl:defmethod cl:initialize-instance :after ((m <MsgEmission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgEmission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_control-msg:<MsgEmission> is deprecated: use laser_control-msg:MsgEmission instead.")))

(cl:ensure-generic-function 'emission-val :lambda-list '(m))
(cl:defmethod emission-val ((m <MsgEmission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:emission-val is deprecated.  Use laser_control-msg:emission instead.")
  (emission m))
