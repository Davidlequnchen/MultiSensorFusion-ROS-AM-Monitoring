...
(cl:in-package laser_control-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MsgInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_control-msg:<MsgInfo> is deprecated: use laser_control-msg:MsgInfo instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MsgInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:header-val is deprecated.  Use laser_control-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <MsgInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:time-val is deprecated.  Use laser_control-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'track_number-val :lambda-list '(m))
(cl:defmethod track_number-val ((m <MsgInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_control-msg:track_number-val is deprecated.  Use laser_control-msg:track_number instead.")
  (track_number m))
