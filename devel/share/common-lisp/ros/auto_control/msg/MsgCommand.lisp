...
(cl:defmethod cl:initialize-instance :after ((m <MsgCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auto_control-msg:<MsgCommand> is deprecated: use auto_control-msg:MsgCommand instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <MsgCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auto_control-msg:command-val is deprecated.  Use auto_control-msg:command instead.")
  (command m))
