...
(cl:defmethod cl:initialize-instance :after ((m <MsgCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scanning_robviz-msg:<MsgCommand> is deprecated: use scanning_robviz-msg:MsgCommand instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <MsgCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scanning_robviz-msg:command-val is deprecated.  Use scanning_robviz-msg:command instead.")
  (command m))
