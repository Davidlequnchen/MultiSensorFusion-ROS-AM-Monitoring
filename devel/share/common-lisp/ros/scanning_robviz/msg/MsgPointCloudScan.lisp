...
(cl:defmethod cl:initialize-instance :after ((m <MsgPointCloudScan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgPointCloudScan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scanning_robviz-msg:<MsgPointCloudScan> is deprecated: use scanning_robviz-msg:MsgPointCloudScan instead.")))

(cl:ensure-generic-function 'ready-val :lambda-list '(m))
(cl:defmethod ready-val ((m <MsgPointCloudScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scanning_robviz-msg:ready-val is deprecated.  Use scanning_robviz-msg:ready instead.")
  (ready m))

(cl:ensure-generic-function 'scanning_count-val :lambda-list '(m))
(cl:defmethod scanning_count-val ((m <MsgPointCloudScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scanning_robviz-msg:scanning_count-val is deprecated.  Use scanning_robviz-msg:scanning_count instead.")
  (scanning_count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MsgPointCloudScan>)))
  ...
  "scanning_robviz/MsgPointCloudScan")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MsgPointCloudScan)))
  "Returns string type for a message object of type 'MsgPointCloudScan"
  "scanning_robviz/MsgPointCloudScan")
