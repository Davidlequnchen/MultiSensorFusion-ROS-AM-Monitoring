...
"""autogenerated by genpy from infratec_image_processing/TemperatureFeature.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,highest,lowest,variance,kurtosis,skewness
    ...
    """
    if args or kwds:
      super(TemperatureFeature, self).__init__(*args, **kwds)
